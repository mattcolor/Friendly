...
#import "FRInviteFriendsCell.h"
#import "FRStyleKit.h"

@interface FRInviteFriendsCell ()
...
@implementation FRInviteFriendsCell
...
- (UILabel*)subtitle
{
    if (!_subtitle)
    {
        ...
        [_subtitle mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.iconFBImage.mas_right).offset(15);
            make.right.equalTo(self.arrowImage.mas_left).offset(-10);
            make.top.equalTo(self.iconFBImage.mas_centerY);
        }];
    }
    return _subtitle;
}
